...
//!
//! let s = "Hello".to_u32string();
//!
//! let message = s + ustr!(" world!");
//! ```
//!
...
/// # Examples
///
/// You can create a `U32String` from [a literal string][`&str`] with [`U32String::from_str`]:
///
...
/// # Deref
///
/// `U32String` implements <code>[Deref]<Target = [u32str]></code>, and so inherits all of [`u32str`]'s
/// methods. In addition, this means that you can pass a `U32String` to a
/// function which takes a [`&u32str`] by using an ampersand (`&`):
///
/// ```
/// use u32_string::{u32str, U32String};
///
/// fn takes_str(s: &u32str) { }
///
...
/// ```
///
/// This will create a [`&u32str`] from the `U32String` and pass it in. This
/// conversion is very inexpensive, and so generally, functions will accept
/// [`&u32str`]s as arguments unless they need a `U32String` for some specific
/// reason.
///
/// In certain cases Rust doesn't have enough information to make this
/// conversion, known as [`Deref`] coercion. In the following example a string
/// slice [`&'a u32str`][`&u32str`] implements the trait `TraitExample`, and the function
...
/// trait TraitExample {}
///
/// impl<'a> TraitExample for &'a u32str {}
///
